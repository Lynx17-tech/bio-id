                    ...
                    newRow.innerHTML = `
                        ...
                        <td>
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <img src="../images/${admin.assigned_municipality.toLowerCase().replace(/\s+/g, '_')}_logo.png" 
                                     onerror="if(this.src.endsWith('.png')) this.src=this.src.replace('.png','.jpg'); else if(this.src.endsWith('.jpg')) this.src=this.src.replace('.jpg','.jpeg'); else this.style.display='none';" 
